...
var Input = /*#__PURE__*/forwardRef(function (_ref9, ref) {
  var mt = _ref9.mt,
    mr = _ref9.mr,
    mb = _ref9.mb,
    ml = _ref9.ml,
...
var MonthSelector = function MonthSelector(_ref) {
  var locale = _ref.locale,
    ...
    date = _ref.date,
    currentMonth = _ref.currentMonth;
  var _useState = useState(currentMonth || 0),
    _useState2 = _slicedToArray(_useState, 2),
    focusedButton = _useState2[0],
    setFocusedButton = _useState2[1];
  var buttonRefs = useRef([]);
...
var Calendar = function Calendar(_ref) {
  ...
  var doublePrevYearRef = useRef(null);
  var doublePrevMonthRef = useRef(null);
  var doubleNextYearRef = useRef(null);
  var doubleNextMonthRef = useRef(null);
  var doubleViewRefs = {
    1: doublePrevYearRef,
  ...
  var handleMouseEnter = useCallback(function (day) {
...
var InputField = /*#__PURE__*/forwardRef(function (_ref, ref) {
...
var DatePicker = function DatePicker(_ref) {
  ...
  var _useState = useState(new Date(Date.now())),
    _useState2 = _slicedToArray(_useState, 2),
  ...
  var inputRefEnd = useRef(null);
  var inputRefStart = useRef(null);
  var handleDateRangeClick = useCallback(function (date) {
  ...
  var handleSingleDate = useCallback(function (date) {
    var normalizedDate = normalizeDate(date);
    var today = normalizeDate(new Date());
    if (normalizedDate < today) return;
    setStartDate(date);
  ...
  var isInRange = useCallback(function (day) {
  ...
  var isInHoverRange = useCallback(function (day) {
  ...
  var onChangeCurrent = useCallback(function (val) {
